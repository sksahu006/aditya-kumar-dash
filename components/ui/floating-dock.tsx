...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto flex w-full max-w-[425px] sm:max-w-[500px] h-20 gap-2 sm:gap-4 items-end justify-around rounded-2xl bg-black/70 dark:bg-neutral-900 px-2 sm:px-4 pb-3",
        className
      )}
    >
      {items.map((item) => (
  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className="aspect-square rounded-full bg-black/70 dark:bg-neutral-800 flex items-center justify-center relative"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
