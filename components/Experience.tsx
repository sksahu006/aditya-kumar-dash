...
export default function Experience() {
  return (
    <div className="relative flex flex-col items-start justify-center min-h-screen py-20 gap-10 md:gap-20 pl-4 sm:pl-8 md:pl-12 pr-4 sm:pr-8 text-gray-300">
      
      {/* Experience Card */}
      <div className="relative p-4 md:p-6 shadow-lg rounded-lg border-l-4 border-blue-500 duration-300 w-full">
        <h2 className="mb-2 text-xl md:text-2xl font-bold text-gray-100">
          <TextShimmerWave
      ...
      {/* Experience Card */}
      <div className="relative p-4 md:p-6 shadow-lg rounded-lg border-l-4 border-purple-500 duration-300 w-full">
        <h2 className="mb-2 text-xl md:text-2xl font-bold text-gray-100">
          <TextShimmerWave
            className='[--base-color:#0D74CE] [--base-gradient-color:#5EB1EF]'
            duration={1}
      ...
      {/* Experience Card */}
      <div className="relative p-4 md:p-6 shadow-lg rounded-lg border-l-4 border-pink-500 duration-300 w-full">
        <h2 className="mb-2 text-xl md:text-2xl font-bold text-gray-100">
          <TextShimmerWave
            className='[--base-color:#0D74CE] [--base-gradient-color:#5EB1EF]'
            duration={1}
